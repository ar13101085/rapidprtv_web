...
namespace RapidPRTV.Controllers
{
    public class MediaController : ApiController
    {
        ...
        public const int ReadStreamBufferSize = 1024;
        ...
        static MediaController()
        {
            ...
            //InitialDirectory = System.Web.Hosting.HostingEnvironment.MapPath(@"~/Video/");
            // InitialDirectory = System.Web.Hosting.HostingEnvironment.MapPath(@"C:\");
        }
        ...
        {
            FileInfo fileInfo = new FileInfo(Path.Combine(System.Web.Hosting.HostingEnvironment.MapPath("~/Video/"), f));
